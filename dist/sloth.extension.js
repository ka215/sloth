...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/sloth-extension.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var core_js_modules_es_regexp_constructor__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! core-js/modules/es.regexp.constructor */ "./node_modules/core-js/modules/es.regexp.constructor.js");
/* harmony import */ var core_js_modules_es_regexp_constructor__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_regexp_constructor__WEBPACK_IMPORTED_MODULE_19__);
...
/* harmony import */ var core_js_modules_es_string_ends_with__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! core-js/modules/es.string.ends-with */ "./node_modules/core-js/modules/es.string.ends-with.js");
...
var init = function init() {
  ...
  if (isIOS) {
    ...
    */
    var updateStyles = function updateStyles(element) {
      var fs = parseInt(window.getComputedStyle(element).fontSize),
          pd = {
      ...
      if (fs < 16) {
        ...
        element.style.paddingTop = "".concat(pd.top - (16 - fs) / 2, "px");
        element.style.paddingRight = "".concat(pd.right - (16 - fs) / 2, "px");
        element.style.paddingBottom = "".concat(pd.bottom - (16 - fs) / 2, "px");
        element.style.paddingLeft = "".concat(pd.left - (16 - fs) / 2, "px");
      }
    };

    Array.prototype.forEach.call(document.querySelectorAll('input'), function (elm) {
      var type = elm.type;
    ...
    Array.prototype.forEach.call(document.querySelectorAll('select'), function (elm) {
      updateStyles(elm);
    });
    Array.prototype.forEach.call(document.querySelectorAll('textarea'), function (elm) {
      updateStyles(elm);
    });
  } // Check data-standby attributes


  Array.prototype.forEach.call(document.querySelectorAll('[data-standby]'), function (elm) {
    var standbyEvent = elm.dataset.standby,
        timeoutId;

    if ('shown' === standbyEvent) {
      timeoutId = window.setTimeout(function () {
        elm.removeAttribute('data-standby');
  ...
  Array.prototype.forEach.call(document.getElementsByClassName('upload'), function (elm) {
    ...
    filename.style.width = "calc(100% - (".concat(offset, "px + 5em))");
    ...
    elm.querySelector('[type=file]').addEventListener('change', function (evt) {
      ...
      reader.onload = function () {
        preview.style.backgroundImage = "url(".concat(reader.result, ")");
      ...
      elm.addEventListener('submit', function (evt) {
        ...
        if (slothValidator(self)) {
          ...
          if (callback) {
            ...
            response = Function.call(_this, "return ".concat(callback))();
  ...
  Array.prototype.forEach.call(document.querySelectorAll('.sticky-footer.pullup'), function (elm) {
    ...
    elm.addEventListener('click', function (evt) {
      Array.prototype.forEach.call(elm.querySelectorAll('.toggle-switch'), function (tgl) {
        ...
        observer.observe(tgl, {
          attributes: true,
          attributeOldValue: true
        });

        if (isOpen && evt.target.closest('.pullup-content')) {//evt.preventDefault()
        } else {
  ...
  Array.prototype.forEach.call(document.querySelectorAll('[data-toc]'), function (elm) {
    ...
    if (targetElms.length > 0) {
      ...
      var matches = targetElms[0].querySelectorAll('h1, h2, h3, h4, h5, h6'),
          ul = document.createElement('ul'),
          list = [],
          lilv = 6;
      Array.prototype.forEach.call(matches, function (headline) {
        var id = headline.id,
        ...
        if (id === '') {
          ...
          headline.id = id;
          headline.insertAdjacentHTML('afterbegin', "<a name=\"".concat(id, "\"></a>"));
        }

        lilv = hlv < lilv ? hlv : lilv; //console.log(headline.tagName, hlv, lilv, headline.textContent, headline.id);
      ...
      list.forEach(function (li_elm) {
        var indent = parseInt(li_elm.dataset.indent, 10) - lilv;

        if (cascading && indent > 0) {
          li_elm.classList.add("idt-".concat(indent));
        }
      ...
      elm.appendChild(ul);
      Array.prototype.forEach.call(elm.querySelectorAll('a[href*="#"]'), function (link) {
        link.addEventListener('click', function (evt) {
          var href = evt.target.getAttribute('href'),
              _tmp = href.split('#'),
              targetId = _tmp[1],
              target = document.getElementById(targetId); //console.log(href, target);
          //location.hash = href;
  ...
  Array.prototype.forEach.call(document.querySelectorAll('[data-follow-color]'), function (elm) {
    ...
    input.addEventListener('change', function (evt) {
      if ('radio' === evt.target.type && evt.target.name != undefined && evt.target.name != '') {
        Array.prototype.forEach.call(document.querySelectorAll("input[name=".concat(evt.target.name, "]")), function (radioElm) {
...
var optimizeDropdown = function optimizeDropdown() {
  Array.prototype.forEach.call(document.getElementsByTagName('select'), function (elm) {
    if (elm.parentNode.classList.contains('dropdown')) {
      ...
      maxLength = Math.max.apply(null, optionSizes); //console.log(elm.name, parseInt(window.getComputedStyle(elm).width), maxLength, elm.parentNode.nextElementSibling);

      elm.style.width = "".concat(maxLength + parseInt(window.getComputedStyle(elm).fontSize) * 3, "px");
      /*
...
var adjustColumnsInRow = function adjustColumnsInRow() {
...
var parseObject = function parseObject(str) {
  var _this2 = this;
    ...
    _tmp = _tmp.reduce(function (obj, x, i) {
      if (x[0] && x[1]) {
        ...
        if (/^callback$/i.test(prop)) {
          obj[prop] = Function.call(_this2, "return ".concat(value))();
        } else {
          obj[prop] = value;
        }
      } else if (x.length == 1 && x[0]) {
        var _value2 = x[0].trim().replace(/^('|")+|("|')+$/g, '');
...
var generateDialog = function generateDialog(title, content, foot, effect, size) {
  return new Promise(function (resolve) {
    ...
    insertTitle = function insertTitle() {
      ...
      foot = foot ? typeof foot === 'string' && /^\{+.*\}$/.test(foot) ? parseObject(foot) : foot : true; //foot = foot ? (typeof foot === 'string' ? parseObject(foot) : foot) : true;
...
var slothNotify = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, content, foot, effect, size) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return generateDialog(title, content, foot, effect, size);
...
var showDialog = function showDialog(title, content, foot, effect, size, reinit) {
  slothNotify(title, content, foot, effect, size).then(function (dialog) {
...
var strLength = function strLength(str) {
  ...
  var fs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1rem';
  var size = {
    width: 0,
    height: 0
  },
      ruler; // Add a string length ruler element
...
var slothValidator = function slothValidator(form) {
  ...
  if (Object.keys(messages).length > 0) {
    ...
    Object.keys(messages).forEach(function (_v) {
      ...
      item.innerHTML = "<label>".concat(_v, ":</label><span>").concat(messages[_v], "</span>");
      list.append(item);
    });
...
var singleFieldValidator = function singleFieldValidator(field, formData) {
...
var initializeLazyLoading = function initializeLazyLoading() {
  var ll_images = 0,
      inner_images = 0,
      toHash = function toHash(string, def) {
    var hash = def || 0,
        len = string.length,
        i,
        chr;
  ...
  Array.prototype.forEach.call(document.querySelectorAll('[data-src]'), function (elm) {
    if (/^(img)$/i.test(elm.nodeName) && elm.dataset.src !== 'null' && !elm.getAttribute('src')) {
      if (!/^span$/i.test(elm.parentNode.nodeName) || !elm.parentNode.classList.contains('img-wrap')) {
        var hashId = "llimg-".concat(toHash(elm.outerHTML, ll_images));
        elm.outerHTML = "<span id=\"".concat(hashId, "\" class=\"img-wrap\">").concat(elm.outerHTML, "</span>");
        var parentNode = document.getElementById(hashId).closest('.lazy-load, .dialog-body');
  ...
  if (ll_images > 0) {
    if (inner_images == 0) {
      ...
      Array.prototype.forEach.call(document.querySelectorAll(wrapSelector), function (elm) {
        elm.addEventListener('resize', function () {
...
var lazyLoading = function lazyLoading(selector) {
  ...
  Array.prototype.forEach.call(document.querySelectorAll(target), /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(elm) {
...
var pullupContent = function pullupContent() {
  Array.prototype.forEach.call(document.querySelectorAll('.sticky-footer.pullup'), function (elm) {
    var footerRect = elm.getBoundingClientRect();
    elm.previousElementSibling.style.paddingBottom = "".concat(footerRect.height, "px");
...
var toggleFooter = function toggleFooter() {
  Array.prototype.forEach.call(document.querySelectorAll('.toggle-switch'), function (elm) {
...
var initializeStickyFooter = function initializeStickyFooter() {
  Array.prototype.forEach.call(document.querySelectorAll('.sticky-footer'), function (elm) {
...
var makeId = function makeId(str) {
  ...
  return "note-".concat(Math.abs(hash));
};
/*
...
var smoothScroll = function smoothScroll(target) {
  ...
  var nowY = window.pageYOffset,
      offset = 0,
      toY;
  Array.prototype.forEach.call(document.querySelectorAll('.navi-menu'), function (elm) {
...
/******/ });
//# sourceMappingURL=sloth.extension.js.map