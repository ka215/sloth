...
var init = function init() {
  ...
  window.toggleFooter = toggleFooter; // Binding resize event
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(title, content, foot, effect, reinit) {
...
var showDialog = function showDialog(title, content, foot, effect, reinit) {
  slothNotify(title, content, foot, effect, reinit).then(function (dialog) {
