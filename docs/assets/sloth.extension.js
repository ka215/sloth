...
/* harmony import */ var core_js_modules_es_string_ends_with__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! core-js/modules/es.string.ends-with */ "./node_modules/core-js/modules/es.string.ends-with.js");
...
var optimizeDropdown = function optimizeDropdown() {
  Array.prototype.forEach.call(document.getElementsByTagName('select'), function (elm) {
    if (elm.parentNode.classList.contains('dropdown')) {
      ...
      elm.style.width = "calc(".concat(Math.max.apply(null, optionLengths), "px + 3em)");
  ...
  Array.prototype.forEach.call(document.querySelectorAll('form > .flx-row, form > .inline'), function (elm) {
    ...
    if (children.length == 2) {
      ...
      if (lastElm.nodeName === 'DIV' && offset) {
        lastElm.style.width = "calc(100% - ".concat(offset, "px - 2em)");
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(title, content, foot, effect, size) {
