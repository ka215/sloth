<header id="demo-navi" class="navi-menu">
  <div class="flx-row">
    <label class="toggle">
      ...
      <div class="menu">
        <ul class="unstyled">
          ...
          <li class="pr1"><a href="./?page=2"><span class="mr1" data-size="w:1rem"><i class="far fa-lightbulb"></i></span>Sloth Extensions</a></li>
        </ul>
        <hr>
        <ul class="unstyled">
          <li class="pr1"><a href="./donation.html"><span class="mr1" data-size="w:1rem"><i class="fas fa-donate"></i></span>Donation</a></li>
    ...
    <a href="#sloth-docs" class="brand"><img src="./sloth.svg" height="36"> Sloth</a>
  </div>
</header>
<div class="my1" data-switch-class="sm:mx1,md:mx2,lg:mx2">
  ...
  <table class="cell-center" data-switch-class="sm:fixed">
    <thead>
      ...
      <tr>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Chrome" src="icons/chrome.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Firefox" src="icons/firefox.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Safari" src="icons/safari.png" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Edge" src="icons/edge.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Opera" src="icons/opera.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Internet Explorer 10-11" src="icons/ie.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <!-- th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Android Browser" src="icons/android.svg" data-size="w:100%,mw:44px,minw:20px"></th -->
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="Chrome" src="icons/chrome.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th data-size="w:(100% / 10),minw:(100% / 10),mw:62px"><img alt="iOS Safari" src="icons/safari_ios.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      </tr>
    </thead>
    <tbody>
      <tr>
    ...
    <tfoot>
      <tr>
      <th rowspan="2"></th>
      <th><img alt="Chrome" src="icons/chrome.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="Firefox" src="icons/firefox.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="Safari" src="icons/safari.png" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="Edge" src="icons/edge.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="Opera" src="icons/opera.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="Internet Explorer 10-11" src="icons/ie.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <!-- th><img alt="Android Browser" src="icons/android.svg" data-size="w:100%,mw:44px,minw:20px"></th -->
      <th><img alt="Chrome" src="icons/chrome.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      <th><img alt="iOS Safari" src="icons/safari_ios.svg" data-size="w:100%,mw:44px,minw:20px"></th>
      </tr>
      <tr>
      <th colspan="6">PC</th>
      <th colspan="2">Mobile</th>
