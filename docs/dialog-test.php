<?php
$dir_name = 'dist';// 'assets'
$sloth_style_path  = $dir_name . '/sloth.min.css';
$sloth_script_path = $dir_name . '/sloth.extension.js';
$sloth_css_url = $sloth_style_path .'?'. filemtime( __DIR__ .'/'. $sloth_style_path );
$sloth_js_url  = $sloth_script_path .'?'. filemtime( __DIR__ .'/'. $sloth_script_path );
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="stylesheet" href="<?= $sloth_css_url ?>">
...
<body class="sloth"<?php /* data-dialog-effect="1" data-dialog-button="outline" */ ?> data-standby="shown">
  <header id="docs-navi" class="navi-menu">
  </header>
  <main class="mx2" style="margin-top:60px;">
  ...
  <footer id="demo-footer">
    <p class="txt-center">Crafted with &copy; <time><?= date( 'Y' ); ?></time> MAGIC METHODS by <a href="https://ka2.org/">ka2</a></p>
  </footer>
  <a id="back-to-head" class="btn-fab clr-quin" href="#sloth-docs"><i class="fas fa-arrow-up"></i></a>
  <script async src="<?= $sloth_js_url ?>"></script>
</body>
</html>
